...
#ifndef MOUSIR_UNIT_TESTS_TEST_APT_POOR_ACTIVATOR_POINTER_TO_FUNCTION_LVALUE_REFERENCE_H
#define MOUSIR_UNIT_TESTS_TEST_APT_POOR_ACTIVATOR_POINTER_TO_FUNCTION_LVALUE_REFERENCE_H
...
{
    std::cout << "Function pointer called by lvalue reference" << std::endl;
}
