...
#ifndef MOUSIR_UNIT_TESTS_TEST_APT_POOR_ACTIVATOR_POINTER_TO_FUNCTION_REGULAR_H
#define MOUSIR_UNIT_TESTS_TEST_APT_POOR_ACTIVATOR_POINTER_TO_FUNCTION_REGULAR_H
...
{
    std::cout << "Function pointer called by regular argument" << std::endl;
}
