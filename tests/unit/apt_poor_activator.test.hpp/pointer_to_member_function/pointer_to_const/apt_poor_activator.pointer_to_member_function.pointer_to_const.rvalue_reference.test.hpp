...
#ifndef MOUSIR_UNIT_TESTS_TEST_APT_POOR_ACTIVATOR_POINTER_TO_MEMBER_FUNCTION_POINTER_TO_CONST_RVALUE_REFERENCE_H
#define MOUSIR_UNIT_TESTS_TEST_APT_POOR_ACTIVATOR_POINTER_TO_MEMBER_FUNCTION_POINTER_TO_CONST_RVALUE_REFERENCE_H
...
struct Caller
{
    ...
    {
        std::cout << "Pointer to const member function called by rvalue reference" << std::endl;
    }
};
...
struct CallerDescendant: public Caller
{
    ...
    {
        std::cout << "Descendant pointer to const member function called by rvalue reference" << std::endl;
    }
};
