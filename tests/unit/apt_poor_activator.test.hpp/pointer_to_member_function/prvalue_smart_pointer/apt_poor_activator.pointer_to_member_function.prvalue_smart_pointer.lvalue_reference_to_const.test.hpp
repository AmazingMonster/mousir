...
#ifndef MOUSIR_UNIT_TESTS_TEST_APT_POOR_ACTIVATOR_POINTER_TO_MEMBER_FUNCTION_PRVALUE_SMART_POINTER_LVALUE_REFERENCE_TO_CONST_H
#define MOUSIR_UNIT_TESTS_TEST_APT_POOR_ACTIVATOR_POINTER_TO_MEMBER_FUNCTION_PRVALUE_SMART_POINTER_LVALUE_REFERENCE_TO_CONST_H
...
struct Caller
{
    ...
    virtual void fun(Argument const &)
    {
        std::cout << "Pointer to member function called by lvalue reference to const" << std::endl;
    }
};
...
struct CallerDescendant: public Caller
{
    ...
    {
        std::cout << "Descendant pointer to member function called by lvalue reference to const" << std::endl;
    }
};
