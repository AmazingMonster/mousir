...
#ifndef MOUSIR_UNIT_TESTS_TEST_APT_POOR_ACTIVATOR_POINTER_TO_MEMBER_FUNCTION_LVALUE_SMART_POINTER_TO_CONST_RVALUE_REFERENCE_H
#define MOUSIR_UNIT_TESTS_TEST_APT_POOR_ACTIVATOR_POINTER_TO_MEMBER_FUNCTION_LVALUE_SMART_POINTER_TO_CONST_RVALUE_REFERENCE_H
