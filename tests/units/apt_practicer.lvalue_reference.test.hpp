...
#ifndef MOUSIR_TESTS_UNIT_APT_PRACTICER_LVALUE_REFERENCE_H
#define MOUSIR_TESTS_UNIT_APT_PRACTICER_LVALUE_REFERENCE_H
...
namespace Mousir {
namespace TestAptPracticerLvalueReference {
...
inline void test()
{
    ...
    AptPracticer<Argument const &, bool> pra(correspondence);
