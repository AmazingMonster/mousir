...
#ifndef MOUSIR_TESTS_UNIT_APT_PRACTICER_ORDINARY_H
#define MOUSIR_TESTS_UNIT_APT_PRACTICER_ORDINARY_H
...
namespace Mousir {
namespace TestAptPracticerOrdinary {
...
inline void test()
{
    ...
    AptPracticer<Argument, bool> pra(correspondence);
