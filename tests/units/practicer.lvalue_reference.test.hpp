...
#ifndef CONCEPTRODON_TESTS_UNIT_PRACTICER_LVALUE_REFERENCE_H
#define CONCEPTRODON_TESTS_UNIT_PRACTICER_LVALUE_REFERENCE_H
...
namespace Mousir {
namespace TestPracticerLvalueReference {
...
inline void test()
{
    ...
    Practicer<>::Mold<int>::Mold<Correspondence>::Mold<Argument const &, bool> pra(correspondence);
