...
#ifndef CONCEPTRODON_TESTS_UNIT_RELEASOR_LVALUE_REFERENCE_H
#define CONCEPTRODON_TESTS_UNIT_RELEASOR_LVALUE_REFERENCE_H
...
namespace Mousir {
namespace TestReleasorLvalueReference {
...
inline void test()
{
    ...
    Releasor<>::Mold<int>::Mold<Correspondence>::Mold<Argument const &, bool> rel(correspondence);
