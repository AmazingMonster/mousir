...
#ifndef MOUSIR_TESTS_UNIT_APT_RELEASOR_LVALUE_REFERENCE_H
#define MOUSIR_TESTS_UNIT_APT_RELEASOR_LVALUE_REFERENCE_H
...
namespace Mousir {
namespace TestAptReleasorLvalueReference {
...
inline void test()
{
    ...
    AptReleasor<int>::Mold<Argument const &, bool> rel(correspondence);
