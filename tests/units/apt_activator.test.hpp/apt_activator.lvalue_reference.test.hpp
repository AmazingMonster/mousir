...
#ifndef MOUSIR_TESTS_UNIT_APT_ACTIVATOR_LVALUE_REFERENCE_H
#define MOUSIR_TESTS_UNIT_APT_ACTIVATOR_LVALUE_REFERENCE_H
...
namespace Mousir {
namespace TestAptActivatorLvalueReference {
...
inline void test()
{
    ...
    AptActivator<int>::Mold<Argument const &, bool> act(correspondence);
