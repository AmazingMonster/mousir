...
#ifndef MOUSIR_TESTS_UNIT_APT_BURSTER_LVALUE_REFERENCE_H
#define MOUSIR_TESTS_UNIT_APT_BURSTER_LVALUE_REFERENCE_H
...
namespace Mousir {
namespace TestAptBursterLvalueReference {
...
inline void test()
{
    AptBurster<int>::Mold<Argument const &, bool> bur{};
